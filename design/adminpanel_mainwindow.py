...
class Ui_adminpanel(object):
    def setupUi(self, FentomiApp):
        if not FentomiApp.objectName():
            FentomiApp.setObjectName(u"FentomiApp")
        FentomiApp.resize(400, 300)
        FentomiApp.setMinimumSize(QSize(400, 300))
        FentomiApp.setMaximumSize(QSize(400, 300))
        FentomiApp.setStyleSheet(u"background-color: rgb(32,37,43);")
        self.centralwidget = QWidget(FentomiApp)
...
"font-size: 20px;")
        ...
        self.label_3.setGeometry(QRect(50, 60, 191, 21))
...
"border-radius: 5px;\n"
"color: white;")
        FentomiApp.setCentralWidget(self.centralwidget)

        self.retranslateUi(FentomiApp)

        QMetaObject.connectSlotsByName(FentomiApp)
    # setupUi

    def retranslateUi(self, FentomiApp):
        FentomiApp.setWindowTitle(QCoreApplication.translate("FentomiApp", u"MainWindow", None))
        self.label.setText("")
        self.label_6.setText(QCoreApplication.translate("FentomiApp", u"\u0421\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c \u043e\u0431\u0443\u0447\u0435\u043d\u0438\u044f(\u0437\u0430 \u0441\u0435\u043c.):", None))
        self.pushButton_add.setText(QCoreApplication.translate("FentomiApp", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c", None))
        self.label_7.setText(QCoreApplication.translate("FentomiApp", u"\u0421\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c \u043e\u0431\u0443\u0447\u0435\u043d\u0438\u044f (\u0437\u0430 \u0433\u043e\u0434):", None))
        self.label_5.setText(QCoreApplication.translate("FentomiApp", u"\u0421\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c \u043e\u0431\u0443\u0447\u0435\u043d\u0438\u044f(\u0437\u0430 \u043c\u0435\u0441.):", None))
        self.label_2.setText(QCoreApplication.translate("FentomiApp", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c, \u0438\u0437\u043c\u0435\u043d\u0438\u0442\u044c, \u0443\u0434\u0430\u043b\u0438\u0442\u044c \u0444\u043e\u0440\u043c\u0443", None))
        self.label_3.setText(QCoreApplication.translate("FentomiApp", u"\u0424\u043e\u0440\u043c\u0430 \u043e\u0431\u0443\u0447\u0435\u043d\u0438\u044f:", None))
        self.pushButton_delete.setText(QCoreApplication.translate("FentomiApp", u"\u0423\u0434\u0430\u043b\u0438\u0442\u044c", None))
        self.pushButton_change.setText(QCoreApplication.translate("FentomiApp", u"\u0418\u0437\u043c\u0435\u043d\u0438\u0442\u044c", None))
        self.label_4.setText(QCoreApplication.translate("FentomiApp", u"\u0421\u0440\u043e\u043a \u043e\u0431\u0443\u0447\u0435\u043d\u0438\u044f (\u043c\u0435\u0441):", None))
    # retranslateUi
